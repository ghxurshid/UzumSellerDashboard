...
export const WIDGET_GUIDE = [
  ...
  '      A paragraph. Put figures in it as {{ref}} placeholders and I resolve them in the',
  '      seller\'s locale and currency: "Net profit is {{totals.netProfit}} of',
  '      {{totals.sellPrice}} ({{totals.netMargin}})."',
  ...
  '',
  'NUMBERS — this one is enforced in code, not asked for.',
  '  A text run containing a percent sign, a five-digit run, or grouped thousands is',
  '  DISCARDED on arrival together with whatever it was saying. There are exactly two',
  '  ways to show a figure: {{ref}} inside text, or "ref" on a block. Small integers are',
  '  fine in prose — "three SKUs", "the last 7 days" — because they are counts you are',
  '  reading off a result, not money.',
  '  Only refs that a tool result defined exist. One you invent renders as a dash.',
  '',
